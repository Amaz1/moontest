...
--Total EVA Suit Weight 143 lb (64.9 kg) (-0.3 total)
--Primary Life Support: Vehicle Provided (On destruct, +3 breath)
...
--Operating Pressure: 3.7 psi (25.5 kPa)
--Total EVA Suit Weight 212 lb (96.2 kg) (-0.4 total)
--Primary Life Support: 7 hours (420 minutes) (On destruct, +8 breath)
--Backup Life Support: 30 minutes (Destruction = +11 breath)

--Name: Baseline EMU
--Function: orbital extra-vehicular activity
--Operating pressure: 4.3 psi (29.6 kPa)
--Total shuttle EVA suit weight: 254 lb (115 kg) (-0.5 total)
--Primary life support: 8 hours (480 minutes) (On destruct, +10 breath)
--Backup life support: 30 minutes (Destruction = +11 breath)
...
--Total ISS EVA suit weight: 319 lb (145 kg) (-0.6 total)
--Primary life support: 8 hours (480 minutes) (On destruct, +10 breath)
--Backup life support: 30 minutes (Destruction = +11 breath)
...
minetest.register_tool("spacesuit:helmet_skylab_a7lb", {
	...
	groups = {armor_head=2.5, armor_heal=0, armor_use=2000, armor_healing=0, physics_speed=0, armor_drown=1},
	wear = 0,
})
...
minetest.register_tool("spacesuit:uppertorso_skylab_a7lb", {
	...
	groups = {armor_torso=2.5, armor_heal=0, armor_use=2000, armor_healing=0, physics_speed=-0.1, armor_drown=1},
	wear = 0,
})
...
minetest.register_tool("spacesuit:lowertorso_skylab_a7lb", {
	...
	groups = {armor_legs=2.5, armor_heal=0, armor_use=2000, armor_healing=0, physics_speed=-0.1, armor_drown=1},
	wear = 0,
})
...
minetest.register_tool("spacesuit:boots_skylab_a7lb", {
	...
	groups = {armor_feet=2.5, armor_heal=0, armor_use=2000, armor_healing=0, physics_speed=-0.1, armor_drown=0},
	wear = 0,
})
...
minetest.register_tool("spacesuit:helmet_apollo_a7lb", {
	...
	groups = {armor_head=2.5, armor_heal=0, armor_use=1500, armor_healing=0, physics_speed=-0.1, armor_drown=2},
	wear = 0,
})
...
minetest.register_tool("spacesuit:uppertorso_apollo_a7lb", {
	...
	groups = {armor_torso=2.5, armor_heal=0, armor_use=1500, armor_healing=0, physics_speed=-0.1, armor_drown=3},
	wear = 0,
})
...
minetest.register_tool("spacesuit:lowertorso_apollo_a7lb", {
	...
	groups = {armor_legs=2.5, armor_heal=0, armor_use=1500, armor_healing=0, physics_speed=-0.1, armor_drown=2},
	wear = 0,
})
...
minetest.register_tool("spacesuit:boots_apollo_a7lb", {
	...
	groups = {armor_feet=2.5, armor_heal=0, armor_use=1500, armor_healing=0, physics_speed=-0.1, armor_drown=1},
	wear = 0,
})
...
minetest.register_tool("spacesuit:helmet_baseline_emu", {
	...
	groups = {armor_head=2.5, armor_heal=0, armor_use=1000, armor_healing=0, physics_speed=-0.1, armor_drown=2},
	wear = 0,
})
...
minetest.register_tool("spacesuit:uppertorso_baseline_emu", {
	...
	groups = {armor_torso=2.5, armor_heal=0, armor_use=1000, armor_healing=0, physics_speed=-0.2, armor_drown=4},
	wear = 0,
})
...
minetest.register_tool("spacesuit:lowertorso_baseline_emu", {
	...
	groups = {armor_legs=2.5, armor_heal=0, armor_use=1000, armor_healing=0, physics_speed=-0.1, armor_drown=3},
	wear = 0,
})
...
minetest.register_tool("spacesuit:boots_baseline_emu", {
	...
	groups = {armor_feet=2.5, armor_heal=0, armor_use=1000, armor_healing=0, physics_speed=-0.1, armor_drown=1},
	wear = 0,
})
...
minetest.register_tool("spacesuit:helmet_enhanced_emu", {
	...
	groups = {armor_head=2.5, armor_heal=0, armor_use=500, armor_healing=0, physics_speed=-0.1, armor_drown=2},
	wear = 0,
})
...
minetest.register_tool("spacesuit:uppertorso_enhanced_emu", {
	...
	groups = {armor_torso=2.5, armor_heal=0, armor_use=500, armor_healing=0, physics_speed=-0.2, armor_drown=4},
	wear = 0,
})
...
minetest.register_tool("spacesuit:lowertorso_enhanced_emu", {
	...
	groups = {armor_legs=2.5, armor_heal=0, armor_use=500, armor_healing=0, physics_speed=-0.2, armor_drown=3},
	wear = 0,
})
...
minetest.register_tool("spacesuit:boots_enhanced_emu", {
	...
	groups = {armor_feet=2.5, armor_heal=0, armor_use=500, armor_healing=0, physics_speed=-0.1, armor_drown=1},
	wear = 0,
})
...
minetest.register_tool("spacesuit:steel_oxygen_tank", {
	...
	inventory_image = "spacesuit_inv_tank_steel.png",
	groups = {oxygen_level=2000, breath_use=10, armor_use=50000},
	wear = 0,
})

minetest.register_tool("spacesuit:titanium_oxygen_tank", {
	description = "Titanium Oxygen Tank",
	inventory_image = "spacesuit_inv_tank_titanium.png",
	groups = {oxygen_level=1500, breath_use=10, armor_use=40000},
	wear = 0,
})

minetest.register_tool("spacesuit:mese_oxygen_tank", {
	description = "Mese Oxygen Tank",
	inventory_image = "spacesuit_inv_tank_mese.png",
	groups = {oxygen_level=1000, breath_use=10, armor_use=30000},
	wear = 0,
})